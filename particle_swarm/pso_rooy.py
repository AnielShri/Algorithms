...
# bounds=[(0,10),(0,5)]  # input bounds [(x1_min,x1_max),(x2_min,x2_max)...]	


# minimize(parabola, initial, bounds, num_particles=15, maxiter=30, verbose=True)

initial=[1, 1, 1]               # initial starting location [x1,x2...]
bounds=[(0, 5), (0, 5), (0, 5)]  # input bounds [(x1_min,x1_max),(x2_min,x2_max)...]	


minimize(CostFunction, initial, bounds, num_particles=10, maxiter=40, verbose=True)